  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const details = {
        ...
        priorAddress: form.priorAddress,
        monthlyIncome: form.monthlyIncome,
        employer: form.employer,
        employerPhone: form.employerPhone,
        occupants: form.occupants,
        currentLandlord: {
          name: form.currentLandlordName,
          phone: form.currentLandlordPhone,
          email: form.currentLandlordEmail,
        },
      ...
      <div className="min-h-screen">
        ...
        <div className="mx-auto max-w-2xl px-4 py-12">
          <div className="rounded-3xl border border-white/10 bg-ink-800/70 p-8 shadow-luxe">
            <h1 className="text-2xl font-semibold text-champagne-200">Application received</h1>
            ...
            <p className="mt-6 text-sm text-white/70">
              ...
              <a className="font-semibold text-champagne-200 hover:text-champagne-100" href="mailto:leasing@olivehollowproperties.com">leasing@olivehollowproperties.com</a>.
            </p>
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-2xl px-4 py-10">
        <div className="rounded-3xl border border-white/10 bg-ink-800/70 p-8 shadow-luxe">
          <p className="text-xs font-medium text-white/60">4037 Edgewood Rd, Baltimore, MD</p>
          <h1 className="mt-2 text-2xl font-semibold text-champagne-200">Rental application</h1>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                <label className="block text-sm font-medium text-white/80">SSN last 4</label>
                <input
                  name="ssnLast4"
                  value={form.ssnLast4}
                  onChange={handleChange}
            ...
            <div>
              <label className="block text-sm font-medium text-white/80">Prior address (if less than 2 years at current)</label>
              <input
                name="priorAddress"
            ...
            <div>
              <label className="block text-sm font-medium text-white/80">Employer phone (optional)</label>
              <input
                name="employerPhone"
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
              <div className="text-sm font-semibold text-champagne-200">Current landlord (optional)</div>
              <p className="mt-1 text-xs text-white/70">Providing this helps speed up screening.</p>
              <div className="mt-4 grid gap-4 md:grid-cols-2">
                <div>
                  <label className="block text-sm font-medium text-white/80">Landlord name</label>
                  <input
                ...
                <div>
                  <label className="block text-sm font-medium text-white/80">Landlord phone</label>
                  <input
              ...
              <div className="mt-4">
                <label className="block text-sm font-medium text-white/80">Landlord email</label>
                <input
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <label className="block text-sm font-medium text-white/80">Vehicle info (optional)</label>
                <input
                  name="vehicleInfo"
              ...
              <div>
                <label className="block text-sm font-medium text-white/80">Emergency contact (optional)</label>
                <input
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="mt-2 w-full rounded-xl border border-white/10 bg-ink-900/50 px-3 py-2 text-sm text-white placeholder:text-white/40"
                  placeholder="Phone"
                />
              </div>
            </div>
