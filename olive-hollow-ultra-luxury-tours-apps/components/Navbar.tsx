      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        <Link href="/" className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            <div className="text-sm font-semibold tracking-wide text-champagne-200">Olive Hollow Properties</div>
            <div className="text-xs text-white/60">Leasing and management</div>
          </div>
        </Link>
